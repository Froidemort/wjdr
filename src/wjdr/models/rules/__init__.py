...
There is two sources to define rules :
- One is hardcoded in static resources into json located in /resources/rules
- The other is dynamically loaded from files located in environment variable WJDR_RULES_PATHS (not yet implemented)
