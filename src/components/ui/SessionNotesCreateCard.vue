  ...
  <AppCard :title="title" compact>
    <div class="space-y-3">
      ...
      <label class="form-control w-full">
        ...
        <input
          v-model="props.createForm.title"
          type="text"
      ...
      <label class="form-control w-full">
        ...
        <textarea
          v-model="props.createForm.contentText"
      ...
      <label v-if="sessions.length && !selectedSessionId" class="form-control w-full">
        ...
        <select
          v-model="props.createForm.sessionId"
      ...
      <label v-if="isMj" class="label cursor-pointer justify-start gap-3">
        <input v-model="props.createForm.isVisible" type="checkbox" class="toggle toggle-sm" />
