...
3. process.env.NODE\_ENV is replaced with `"production"` during build.
...
## `__VUE_OPTIONS_API__` {#VUE\_OPTIONS\_API}
...
## `__VUE_PROD_DEVTOOLS__` {#VUE\_PROD\_DEVTOOLS}
...
## `__VUE_PROD_HYDRATION_MISMATCH_DETAILS__` {#VUE\_PROD\_HYDRATION\_MISMATCH\_DETAILS}
